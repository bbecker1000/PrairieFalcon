...
data_2019 <- read_excel('Data/qrpt_FalconObservations_2019.xlsx') #2003 - 2021 ADD COMMENT ON WHY THIS IS NEEDED
...
# filter to keep only obs on or before this DaySinceDec15th day for each territory each year,
...
PRFAStates_2022$LateEffect = ifelse(PRFAStates_2022$DaySinceDec15th >= LateCutOff & month(PRFAStates_2022$SurveyDate)<10, 1, 0)
...
PlotStates_2022 #One October, Sep, Aug surveys in 2013
